...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '11529706705f33ad013a4426-15466881',
  'function' => 
  array (
  ),
...
?><div id="main-inner"><article class="entry hentry js-entry-article date-first autopagerize_page_element chars-200 words-100 mode-hatena entry-odd">
  <header class="entry-header"<?php if (!empty($_smarty_tpl->tpl_vars['content']->value['images'])){?><?php  $_smarty_tpl->tpl_vars['array'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['array']->_loop = false;
...
) no-repeat; background-size: cover;"<?php } ?><?php }?>><div<?php if (!empty($_smarty_tpl->tpl_vars['content']->value['images'])){?><?php  $_smarty_tpl->tpl_vars['array'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['array']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['content']->value['images']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['array']->key => $_smarty_tpl->tpl_vars['array']->value){
$_smarty_tpl->tpl_vars['array']->_loop = true;
?> style="height:<?php echo $_smarty_tpl->tpl_vars['array']->value['height'];?>
px; background-color:rgba(255,255,255,0.4);display: -webkit-flex;"<?php } ?><?php }?>><?php if (!empty($_smarty_tpl->tpl_vars['content']->value['images'])){?><span itemprop="image" itemscope itemtype="https://schema.org/ImageObject" style="display: none;"/><meta itemprop="url" content="https://bluesura.github.io/MUGEN/document/State/media/img/<?php echo $_smarty_tpl->tpl_vars['content']->value['images'][0]['src'];?>
