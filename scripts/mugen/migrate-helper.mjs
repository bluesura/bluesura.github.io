...
for (const parameter of doc.parameter) {
  parameter.load_priority_evidence = unknown;
  ...
  else if (parameter.parameter === 'Name') parameter.default = [{ kind: 'derived', display: '呼び出した親の名前に基づくヘルパー名', evidence: official }];
...
doc.parameter.find(parameter => parameter.parameter === 'HelperType').notes = [{ kind: 'deprecated', content: '<p>1.0・1.1の公式資料では Player 型は非推奨として説明されています。旧データにある動作説明と未文書化値の記録は保持しています。</p>', environment: { engine: 'mugen', runtime: ['mugen-1.0-final', 'mugen-1.1-b1'] }, evidence: official }];
